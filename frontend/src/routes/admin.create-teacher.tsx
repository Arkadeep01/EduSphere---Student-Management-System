...
import { teacherAdminApi, subjectAdminApi } from "@/services/adminApi";
...
export const Route = createFileRoute("/admin/create-teacher")({
...
function AdminCreateTeacher() {
  ...
  const createMutation = useMutation({
    mutationFn: (d: Record<string, unknown>) => teacherAdminApi.createTeacher(d),
    onSuccess: (data) => {
