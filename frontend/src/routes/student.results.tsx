...
import {
  ...
  StaggerContainer,
  StaggerItem,
} from "@/components/brand/animations";
        ...
        <Tabs defaultValue="marks" className="mb-6">
          ...
          <TabsContent value="marks" className="mt-4">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-sm font-medium">
                Exam: {exams[0]?.name || "Midterm Examination"}
              </span>
            </div>
          ...
          <TabsContent value="rankings" className="mt-4">
                ...
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">
                      of {rankings.totalStudents} students
                    </p>
                  </CardContent>
                </Card>
              </StaggerItem>
              <StaggerItem>
                <Card>
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {studentProfileData.academic.section}
                    </p>
                  </CardContent>
                </Card>
              </StaggerItem>
            ...
            <Card className="mt-4">
              <CardHeader>
                <CardTitle>
                  Top Students — Class {studentProfileData.academic.class}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
