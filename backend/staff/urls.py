...
urlpatterns = [
    ...
    path("classes/", views.StaffClassListView.as_view(), name="staff-class-list"),
    path("students/create/", views.StaffStudentCreateView.as_view(), name="staff-student-create"),
    path("teachers/", views.StaffTeacherListView.as_view(), name="staff-teacher-list"),
    path("teachers/create/", views.StaffTeacherCreateView.as_view(), name="staff-teacher-create"),
    path("teachers/<int:teacher_id>/", views.StaffTeacherDetailView.as_view(), name="staff-teacher-detail"),
    path("resignations/", views.StaffResignationListView.as_view(), name="staff-resignation-list"),
    path("resignations/<int:resignation_id>/approve/", views.StaffResignationApproveView.as_view(), name="staff-resignation-approve"),
    path("resignations/<int:resignation_id>/reject/", views.StaffResignationRejectView.as_view(), name="staff-resignation-reject"),
    path("director/resignations/<int:resignation_id>/override/", views.StaffResignationOverrideView.as_view(), name="staff-resignation-override"),
